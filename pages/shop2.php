...
<?php 
    ...
    //echo '<pre>'; print_r($linkImage[0][0]); echo '</pre>';
    //echo json_encode( $linkImage, JSON_UNESCAPED_UNICODE);
    $linkAll = $linkImage;
    //$linkImage = $linkImage[0];
    $linkAll = $linkAll[0];
    $link1 = $linkAll['linkImage1'];
    $link2 = $linkAll['linkImage2'];
    $link3 = $linkAll['linkImage3'];
    $link4 = $linkAll['linkImage4'];
    $link5 = $linkAll['linkImage5'];
    $link6 = $linkAll['linkImage6'];
    $link7 = $linkAll['linkImage7'];
    $proverka = 0;
...
<div class="container ">
    ...
    <?php for ( $i =0, $k = 0;$i <count($linkImage);$i++,$k =$k +7) : ?>
        <div class="block blockShop">
        <img id="image<?php echo  $i ;?>" style="/*margin-left: 15%;margin-top: 10px;width: 70%;*/ width: 90%; #364a49;padding: 5%;" class="imgBlock" src="<?php echo $linkImage[$i][0]?>" alt="">
        
        <div class="setka" style="display: flex; ">
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+1 ;?>,0,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+1 ;?>)" class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+2 ;?>,1,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+2 ;?>)"class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+3 ;?>,2,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+3 ;?>)"class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+4 ;?>,3,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+4 ;?>)"class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+5 ;?>,4,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+5 ;?>)"class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+6 ;?>,5,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+6 ;?>)"class="element"></div>
            <div onmouseover='Novedenie([<?php echo  $k+1 ;?>,<?php echo  $k+2 ;?>,<?php echo  $k+3 ;?>,<?php echo  $k+4 ;?>,<?php echo  $k+5 ;?>,<?php echo  $k+6 ;?>,<?php echo  $k+7 ;?>],<?php echo  $k+7 ;?>,6,"#image<?php echo  $i ;?>",<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>)' onmouseout="down(<?php echo  $k+7 ;?>)"class="element"></div>
        </div>
        
        <div style="display: flex;">
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+1 ;?>"></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+2 ;?>" ></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+3 ;?>" ></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+4 ;?>"></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+5 ;?>"></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+6 ;?>"></div></div>
            <div class="elementOval"><div class="oval" id="oval<?php echo  $k+7 ;?>"></div></div>
        </div>
        <div style="text-align: center;">
        <button onclick='linkSetRight("left", "#image<?php echo  $i ;?>",  <?php echo  $k+1 ;?>, <?php echo  $k+2 ;?>, <?php echo  $k+3 ;?>, <?php echo  $k+4 ;?>, <?php echo  $k+5 ;?>, <?php echo  $k+6 ;?>, <?php  echo  $k+7 ; ?>,/*"["+*/<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>/*+"]"*/)' class="shopBotton" ></button>
        <button onclick='linkSetRight("right", "#image<?php echo  $i ;?>",  <?php echo  $k+1 ;?>, <?php echo  $k+2 ;?>, <?php echo  $k+3 ;?>, <?php echo  $k+4 ;?>, <?php echo  $k+5 ;?>, <?php echo  $k+6 ;?>, <?php  echo  $k+7 ; ?>,/*"["+*/<?php echo json_encode( $linkImage[$i], JSON_UNESCAPED_UNICODE);?>/*+"]"*/)' class="shopBotton shopBottonRight" ></button>
        </div>
         <p class="textBlock" style="margin-top: 20px;">Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст</p>
    </div>
    <?php if ( /*$i == count($linkImage)-1 */$proverka ==  1) : ?>
...
<script type="text/javascript">
    ...
    //alert(ot);
    //a = ajax();
    var a = <?php echo json_encode( $linkImage[0], JSON_UNESCAPED_UNICODE);?>;
    //alert(a[0]);
    ...
    /*var linkt = document.querySelector("#image0");
    alert(linkt);*/
...
//alert(1);
    ...
    function Novedenie(arr,i,k,image,links){
        //alert(links[i]);
        var oval;
        for(var q =0;q<arr.length;q++){
            oval = document.querySelector("#oval" + arr[q]);
            oval.style.backgroundColor = "#ffffff"; 
        }
        var element = document.querySelector(image);
        element.src = links[k];
        var oval2 = document.querySelector("#oval" + i);
        oval2.style.backgroundColor = "#6e2e00";
        /*if(i != 0){
