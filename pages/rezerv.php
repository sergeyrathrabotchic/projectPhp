...
<div class="container ">
    ...
    <?php for ( $i =0, $k = 0;$i <count($linkImage);$i++,$k =$k +7) : ?>
        <div class="block blockShop">
        <img id="image<?php echo  $i ;?>;" style="/*margin-left: 15%;margin-top: 10px;width: 70%;*/ width: 90%; #364a49;padding: 5%;" class="imgBlock" src="<?php echo $linkImage[0][0]?>" alt="">
        ...
        <button onclick="linkSetRight('left', '#image<?php echo  $i ;?>', <?php echo  $k+1 ;?>, <?php echo  $k+2 ;?>, <?php echo  $k+3 ;?>, <?php echo  $k+4 ;?>, <?php echo  $k+5 ;?>, <?php echo  $k+6 ;?>, <?php echo  $k+7 ;?>)" class="shopBotton" ></button>
        <button onclick="linkSetRight('right', '#image<?php echo  $i ;?>',  <?php echo  $k+1 ;?>, <?php echo  $k+2 ;?>, <?php echo  $k+3 ;?>, <?php echo  $k+4 ;?>, <?php echo  $k+5 ;?>, <?php echo  $k+6 ;?>, <?php echo  $k+7 ;?>)" class="shopBotton shopBottonRight" ></button>
        </div>
         <p class="textBlock" style="margin-top: 20px;">Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст Проверочный текст</p>
    </div>
    <?php if ( $i == count($linkImage)-1  ) : ?>
